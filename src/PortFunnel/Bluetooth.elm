...
-- Bluetooth.elm
--
-- Access the Bluetooth Web API via PortFunnel ports.
--
...
module PortFunnel.Bluetooth exposing
...
This code is currently a copy of elm-websocket library, with the top-level name changed.
...
import PortFunnel.Bluetooth.InternalMessage
    exposing
        ( InternalMessage(..)
        , PIClosedRecord
        , PIErrorRecord
...
{-| Internal state of the Bluetooth module.
...
{-| The name of this module: "Bluetooth".
-}
moduleName : String
moduleName =
    "Bluetooth"
